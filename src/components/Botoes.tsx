  ...
  return (
    <div className="flex flex-col md:flex-row gap-4 mt-10 justify-center">
      ...
      <Link target="_blank" href="https://www.instagram.com/morelifersl/">
        <button className="cursor-pointer px-8 py-3 rounded-2xl bg-gradient-to-r from-red-600 to-orange-500 text-white font-bold shadow-lg hover:shadow-red-500/40 hover:scale-105 transition">
          Instagram
        </button>
      </Link>
